...
var candidateListKeys = [
  'id candidateId title mediaTitle status open closed public draft deleted',
  'participants voted createdAt updatedAt closingAt',
...
app.post('/candidate/create', restrict, hasAccess, function (req, res, next) {
  ...
  api.candidate.create(req.body, function (err, candidate) {
    ...
    var keys = [
      'id candidateId title mediaTitle body clauses source state',
      'status open closed public draft deleted participants',
...
app.post('/candidate/:id/publish', restrict, hasAccess, function (req, res) {
  ...
  api.candidate.get(req.params.id, function (err, candidate) {
    ...
    candidate.save(function (err, saved) {
      ...
      var data = {
        candidate: { mediaTitle: candidate.mediaTitle, id: candidate.id },
        url: candidateUrl
      };
