...
var candidateListKeys = [
  'id firstName lastName pictureUrl email phone postal fullName acceptedNomination status open closed public draft deleted whatIsLife secondChartePos thirdChartePos fourthChartePos fifthChartePos firstProp secondProp thirdProp',
...
app.post('/candidate/create', restrict, hasAccess, function (req, res, next) {
  ...
  api.candidate.create(req.body, function (err, candidate) {
    ...
    var keys = [
      'id firstName lastName fullName pictureUrl postal email phone body state whatIsLife secondChartePos thirdChartePos fourthChartePos fifthChartePos firstProp secondProp thirdProp',
