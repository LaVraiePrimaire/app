...
var candidateListKeys = [
  'id candidateId firstName lastName email phone postal fullName acceptedNomination status open closed public draft deleted',
...
app.get('/candidate/:id', function (req, res) {
  ...
  api.candidate.get(req.params.id, function (err, candidate) {
	...
	log('Exposed candidate postal: %s', candidateJson.postal);
