...
exports.all = function all(fn) {
  ...
  .exec(function (err, users) {
    ...
    log('dbapi - Delivering all users %j', pluck(users, 'id'));
    fn(null, users);
  });
  return this;
}
...
exports.expose.confidential = function(user){
  return expose('id firstName lastName displayName email phonenum zipcode avatar staff notifications locale originIp disabledAt')(user);
}
