...
exports.all = function all(params, fn) {
  ...
  Candidate
  .find(query)
  .select('id firstName lastName fullName pictureUrl whatIsLife secondChartePos thirdChartePos fourthChartePos fifthChartePos postal email phone participants votes createdAt updatedAt closingAt publishedAt deletedAt acceptedNominationAt status open closed acceptedNomination links')
