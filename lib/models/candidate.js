...
var LinkSchema = new Schema({
  ...
  , type: { type: String, validate: validators.isIn(['facebook', 'twitter', 'wikipedia', 'media', 'personal'])}
});
...
var CandidateSchema = new Schema({
  ...
  , lastName: { type: String, validate: validators.isAlpha() }
  , contact: {
	  postal: { type: String },
...
/**
 * Compile candidateId to generate
...
CandidateSchema.virtual('content').get(function() {
...
CandidateSchema.virtual('upvotes').get(function() {
...
CandidateSchema.virtual('downvotes').get(function() {
  if (!this.votes) return;
  return this.votes.filter(function(v) {
...
CandidateSchema.virtual('abstentions').get(function() {
  if (!this.votes) return;
  return this.votes.filter(function(v) {
...
CandidateSchema.methods.vote = function(user, value, cb) {
