...
var CommentReplySchema = new Schema({
  ...
  , selfComment: { type: Boolean, default: false }
  , createdAt: { type: Date, default: Date.now }
  , editedAt: { type: Date }
});
...
var CommentSchema = new Schema({
  ...
  // Discussion Context
  , context:    { type: String, required: true, enum: ['proposal', 'candidate', 'clause', 'body', 'paragraph'] }
  // If the context is clause or body, we save a reference to the candidate to get the Side Comments of a Candidate
