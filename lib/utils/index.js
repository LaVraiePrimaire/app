 ...
 */
exports.buildUrl = function buildUrl(inclProtocol, options) {
...
/*options.protocol = (options.protocol || config.protocol).toLowerCase();
  ...
  */
  ...
  var protocol = inclProtocol ? 'http' : '';
  var hostname = "app.lavraieprimaire.fr";
  var pathname = options.pathname ? options.pathname : '/';
  return protocol + hostname + pathname;
};

function inferPort(config, options) {
  return 'https' == options.protocol ? config.https.port : process.env.PORT;
}
